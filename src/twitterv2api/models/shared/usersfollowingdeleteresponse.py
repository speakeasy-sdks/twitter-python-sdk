...
class UsersFollowingDeleteResponseData:
...
class UsersFollowingDeleteResponse:
    data: Optional[UsersFollowingDeleteResponseData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
