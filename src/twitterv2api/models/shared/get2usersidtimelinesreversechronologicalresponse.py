...
class Get2UsersIDTimelinesReverseChronologicalResponse:
    ...
    meta: Optional[Get2UsersIDTimelinesReverseChronologicalResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
