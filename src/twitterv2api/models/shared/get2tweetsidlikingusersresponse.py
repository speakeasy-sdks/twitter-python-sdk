...
class Get2TweetsIDLikingUsersResponseMeta:
...
class Get2TweetsIDLikingUsersResponse:
    ...
    meta: Optional[Get2TweetsIDLikingUsersResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
