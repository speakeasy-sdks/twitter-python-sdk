...
class Get2UsersIDBlockingResponseMeta:
...
@dataclass_json
@dataclasses.dataclass
class Get2UsersIDBlockingResponse:
    ...
    meta: Optional[Get2UsersIDBlockingResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
