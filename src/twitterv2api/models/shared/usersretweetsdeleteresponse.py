...
class UsersRetweetsDeleteResponseData:
...
class UsersRetweetsDeleteResponse:
    data: Optional[UsersRetweetsDeleteResponseData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
