...
class Get2SpacesByCreatorIdsResponseMeta:
...
class Get2SpacesByCreatorIdsResponse:
    ...
    meta: Optional[Get2SpacesByCreatorIdsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
