...
class UsersFollowingCreateResponseData:
    ...
    pending_follow: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pending_follow') }})
    

@dataclass_json
@dataclasses.dataclass
class UsersFollowingCreateResponse:
    data: Optional[UsersFollowingCreateResponseData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
