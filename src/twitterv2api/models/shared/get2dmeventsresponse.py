...
class Get2DmEventsResponseMeta:
...
class Get2DmEventsResponse:
    ...
    meta: Optional[Get2DmEventsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
