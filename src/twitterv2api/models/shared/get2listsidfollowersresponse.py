...
@dataclass_json
@dataclasses.dataclass
class Get2ListsIDFollowersResponse:
    ...
    meta: Optional[Get2ListsIDFollowersResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
