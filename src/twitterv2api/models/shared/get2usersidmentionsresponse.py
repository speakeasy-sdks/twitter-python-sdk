...
@dataclass_json
@dataclasses.dataclass
class Get2UsersIDMentionsResponse:
    ...
    meta: Optional[Get2UsersIDMentionsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
