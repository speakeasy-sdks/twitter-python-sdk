...
class Get2UsersIDMutingResponseMeta:
...
@dataclass_json
@dataclasses.dataclass
class Get2UsersIDMutingResponse:
    ...
    meta: Optional[Get2UsersIDMutingResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
