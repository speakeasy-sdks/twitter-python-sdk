...
class Get2TweetsIDRetweetedByResponseMeta:
...
@dataclass_json
@dataclasses.dataclass
class Get2TweetsIDRetweetedByResponse:
    ...
    meta: Optional[Get2TweetsIDRetweetedByResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
