...
@dataclass_json
@dataclasses.dataclass
class Get2DmConversationsIDDmEventsResponse:
    ...
    meta: Optional[Get2DmConversationsIDDmEventsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
