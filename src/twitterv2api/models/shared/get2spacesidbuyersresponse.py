...
class Get2SpacesIDBuyersResponseMeta:
...
class Get2SpacesIDBuyersResponse:
    ...
    meta: Optional[Get2SpacesIDBuyersResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
