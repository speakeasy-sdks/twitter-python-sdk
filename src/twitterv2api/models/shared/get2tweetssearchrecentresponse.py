...
class Get2TweetsSearchRecentResponseMeta:
...
class Get2TweetsSearchRecentResponse:
    ...
    meta: Optional[Get2TweetsSearchRecentResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
