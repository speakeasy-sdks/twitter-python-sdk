...
class Get2UsersIDBookmarksResponseMeta:
...
@dataclass_json
@dataclasses.dataclass
class Get2UsersIDBookmarksResponse:
    ...
    meta: Optional[Get2UsersIDBookmarksResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
