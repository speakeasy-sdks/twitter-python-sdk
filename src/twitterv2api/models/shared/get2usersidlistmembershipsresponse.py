...
class Get2UsersIDListMembershipsResponseMeta:
...
@dataclass_json
@dataclasses.dataclass
class Get2UsersIDListMembershipsResponse:
    ...
    meta: Optional[Get2UsersIDListMembershipsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
