...
class Get2UsersIDOwnedListsResponseMeta:
...
@dataclass_json
@dataclasses.dataclass
class Get2UsersIDOwnedListsResponse:
    ...
    meta: Optional[Get2UsersIDOwnedListsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
