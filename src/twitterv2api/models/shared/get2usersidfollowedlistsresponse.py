...
class Get2UsersIDFollowedListsResponseMeta:
...
class Get2UsersIDFollowedListsResponse:
    ...
    meta: Optional[Get2UsersIDFollowedListsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
