...
class Get2UsersIDFollowersResponseMeta:
...
class Get2UsersIDFollowersResponse:
    ...
    meta: Optional[Get2UsersIDFollowersResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
