...
class Get2TweetsIDQuoteTweetsResponseMeta:
...
@dataclass_json
@dataclasses.dataclass
class Get2TweetsIDQuoteTweetsResponse:
    ...
    meta: Optional[Get2TweetsIDQuoteTweetsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
