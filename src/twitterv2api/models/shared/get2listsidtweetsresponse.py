...
class Get2ListsIDTweetsResponseMeta:
...
class Get2ListsIDTweetsResponse:
    ...
    meta: Optional[Get2ListsIDTweetsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
