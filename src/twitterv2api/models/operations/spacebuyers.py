...
from ..shared import get2spacesidbuyersresponse as shared_get2spacesidbuyersresponse
from ..shared import problem as shared_problem


@dataclasses.dataclass
class SpaceBuyersPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class SpaceBuyersQueryParams:
...
@dataclasses.dataclass
class SpaceBuyersSecurity:
    o_auth2_user_token: shared_security.SchemeOAuth2UserToken = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class SpaceBuyersRequest:
    path_params: SpaceBuyersPathParams = dataclasses.field()
    query_params: SpaceBuyersQueryParams = dataclasses.field()
    security: SpaceBuyersSecurity = dataclasses.field()
    

@dataclasses.dataclass
class SpaceBuyersResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get2_spaces_id_buyers_response: Optional[shared_get2spacesidbuyersresponse.Get2SpacesIDBuyersResponse] = dataclasses.field(default=None)
