...
from ..shared import get2listsidfollowersresponse as shared_get2listsidfollowersresponse
from ..shared import problem as shared_problem


@dataclasses.dataclass
class ListGetFollowersPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ListGetFollowersQueryParams:
...
@dataclasses.dataclass
class ListGetFollowersSecurity:
...
@dataclasses.dataclass
class ListGetFollowersRequest:
    path_params: ListGetFollowersPathParams = dataclasses.field()
    query_params: ListGetFollowersQueryParams = dataclasses.field()
    security: ListGetFollowersSecurity = dataclasses.field()
    

@dataclasses.dataclass
class ListGetFollowersResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get2_lists_id_followers_response: Optional[shared_get2listsidfollowersresponse.Get2ListsIDFollowersResponse] = dataclasses.field(default=None)
