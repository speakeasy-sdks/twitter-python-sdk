...
@dataclasses.dataclass
class DmConversationWithUserEventIDCreateRequest:
    path_params: DmConversationWithUserEventIDCreatePathParams = dataclasses.field()
    security: DmConversationWithUserEventIDCreateSecurity = dataclasses.field()
    request: Optional[Any] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class DmConversationWithUserEventIDCreateResponse:
