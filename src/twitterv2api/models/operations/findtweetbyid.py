...
from ..shared import get2tweetsidresponse as shared_get2tweetsidresponse
...
class FindTweetByIDRequest:
    path_params: FindTweetByIDPathParams = dataclasses.field()
    query_params: FindTweetByIDQueryParams = dataclasses.field()
    security: FindTweetByIDSecurity = dataclasses.field()
...
class FindTweetByIDResponse:
    ...
    get2_tweets_id_response: Optional[shared_get2tweetsidresponse.Get2TweetsIDResponse] = dataclasses.field(default=None)
