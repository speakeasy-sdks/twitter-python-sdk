...
from ..shared import get2usersidmentionsresponse as shared_get2usersidmentionsresponse
from ..shared import problem as shared_problem


@dataclasses.dataclass
class UsersIDMentionsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class UsersIDMentionsQueryParams:
...
@dataclasses.dataclass
class UsersIDMentionsRequest:
    path_params: UsersIDMentionsPathParams = dataclasses.field()
    query_params: UsersIDMentionsQueryParams = dataclasses.field()
    security: UsersIDMentionsSecurity = dataclasses.field()
    

@dataclasses.dataclass
class UsersIDMentionsResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get2_users_id_mentions_response: Optional[shared_get2usersidmentionsresponse.Get2UsersIDMentionsResponse] = dataclasses.field(default=None)
