...
from ..shared import get2listsidtweetsresponse as shared_get2listsidtweetsresponse
from ..shared import problem as shared_problem


@dataclasses.dataclass
class ListsIDTweetsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ListsIDTweetsQueryParams:
...
@dataclasses.dataclass
class ListsIDTweetsRequest:
    path_params: ListsIDTweetsPathParams = dataclasses.field()
    query_params: ListsIDTweetsQueryParams = dataclasses.field()
    security: ListsIDTweetsSecurity = dataclasses.field()
    

@dataclasses.dataclass
class ListsIDTweetsResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get2_lists_id_tweets_response: Optional[shared_get2listsidtweetsresponse.Get2ListsIDTweetsResponse] = dataclasses.field(default=None)
