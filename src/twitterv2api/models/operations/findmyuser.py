...
from ..shared import get2usersmeresponse as shared_get2usersmeresponse
from ..shared import problem as shared_problem


@dataclasses.dataclass
class FindMyUserQueryParams:
...
@dataclasses.dataclass
class FindMyUserRequest:
    query_params: FindMyUserQueryParams = dataclasses.field()
    security: FindMyUserSecurity = dataclasses.field()
    

@dataclasses.dataclass
class FindMyUserResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get2_users_me_response: Optional[shared_get2usersmeresponse.Get2UsersMeResponse] = dataclasses.field(default=None)
