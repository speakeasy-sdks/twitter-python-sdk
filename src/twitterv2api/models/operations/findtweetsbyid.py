...
from ..shared import get2tweetsresponse as shared_get2tweetsresponse
...
class FindTweetsByIDRequest:
    query_params: FindTweetsByIDQueryParams = dataclasses.field()
    security: FindTweetsByIDSecurity = dataclasses.field()
...
class FindTweetsByIDResponse:
    ...
    get2_tweets_response: Optional[shared_get2tweetsresponse.Get2TweetsResponse] = dataclasses.field(default=None)
