...
from ..shared import get2usersidblockingresponse as shared_get2usersidblockingresponse
from ..shared import problem as shared_problem


@dataclasses.dataclass
class UsersIDBlockingPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class UsersIDBlockingQueryParams:
...
@dataclasses.dataclass
class UsersIDBlockingRequest:
    path_params: UsersIDBlockingPathParams = dataclasses.field()
    query_params: UsersIDBlockingQueryParams = dataclasses.field()
    security: UsersIDBlockingSecurity = dataclasses.field()
    

@dataclasses.dataclass
class UsersIDBlockingResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get2_users_id_blocking_response: Optional[shared_get2usersidblockingresponse.Get2UsersIDBlockingResponse] = dataclasses.field(default=None)
