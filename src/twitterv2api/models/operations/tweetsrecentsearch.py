...
from ..shared import get2tweetssearchrecentresponse as shared_get2tweetssearchrecentresponse
from ..shared import problem as shared_problem

class TweetsRecentSearchSortOrderEnum(str, Enum):
    RECENCY = "recency"
    RELEVANCY = "relevancy"


@dataclasses.dataclass
class TweetsRecentSearchQueryParams:
    ...
    sort_order: Optional[TweetsRecentSearchSortOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort_order', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class TweetsRecentSearchSecurity:
...
@dataclasses.dataclass
class TweetsRecentSearchRequest:
    query_params: TweetsRecentSearchQueryParams = dataclasses.field()
    security: TweetsRecentSearchSecurity = dataclasses.field()
    

@dataclasses.dataclass
class TweetsRecentSearchResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get2_tweets_search_recent_response: Optional[shared_get2tweetssearchrecentresponse.Get2TweetsSearchRecentResponse] = dataclasses.field(default=None)
