...
from ..shared import get2tweetsidretweetedbyresponse as shared_get2tweetsidretweetedbyresponse
from ..shared import problem as shared_problem


@dataclasses.dataclass
class TweetsIDRetweetingUsersPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class TweetsIDRetweetingUsersQueryParams:
...
@dataclasses.dataclass
class TweetsIDRetweetingUsersSecurity:
...
@dataclasses.dataclass
class TweetsIDRetweetingUsersRequest:
    path_params: TweetsIDRetweetingUsersPathParams = dataclasses.field()
    query_params: TweetsIDRetweetingUsersQueryParams = dataclasses.field()
    security: TweetsIDRetweetingUsersSecurity = dataclasses.field()
    

@dataclasses.dataclass
class TweetsIDRetweetingUsersResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get2_tweets_id_retweeted_by_response: Optional[shared_get2tweetsidretweetedbyresponse.Get2TweetsIDRetweetedByResponse] = dataclasses.field(default=None)
