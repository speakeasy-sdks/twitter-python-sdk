...
from ..shared import get2listsidmembersresponse as shared_get2listsidmembersresponse
from ..shared import problem as shared_problem


@dataclasses.dataclass
class ListGetMembersPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ListGetMembersQueryParams:
...
@dataclasses.dataclass
class ListGetMembersRequest:
    path_params: ListGetMembersPathParams = dataclasses.field()
    query_params: ListGetMembersQueryParams = dataclasses.field()
    security: ListGetMembersSecurity = dataclasses.field()
    

@dataclasses.dataclass
class ListGetMembersResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get2_lists_id_members_response: Optional[shared_get2listsidmembersresponse.Get2ListsIDMembersResponse] = dataclasses.field(default=None)
