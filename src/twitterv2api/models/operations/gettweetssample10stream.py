...
from ..shared import get2tweetssample10streamresponse as shared_get2tweetssample10streamresponse
from ..shared import problem as shared_problem


@dataclasses.dataclass
class GetTweetsSample10StreamQueryParams:
...
@dataclasses.dataclass
class GetTweetsSample10StreamSecurity:
    bearer_token: shared_security.SchemeBearerToken = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'http', 'sub_type': 'bearer' }})
    

@dataclasses.dataclass
class GetTweetsSample10StreamRequest:
    query_params: GetTweetsSample10StreamQueryParams = dataclasses.field()
    security: GetTweetsSample10StreamSecurity = dataclasses.field()
    

@dataclasses.dataclass
class GetTweetsSample10StreamResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get2_tweets_sample10_stream_response: Optional[shared_get2tweetssample10streamresponse.Get2TweetsSample10StreamResponse] = dataclasses.field(default=None)
