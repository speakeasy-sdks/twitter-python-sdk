...
class GetTweetsFirehoseStreamQueryParams:
...
@dataclasses.dataclass
class GetTweetsFirehoseStreamSecurity:
    bearer_token: shared_security.SchemeBearerToken = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'http', 'sub_type': 'bearer' }})
    

@dataclasses.dataclass
class GetTweetsFirehoseStreamRequest:
    query_params: GetTweetsFirehoseStreamQueryParams = dataclasses.field()
    security: GetTweetsFirehoseStreamSecurity = dataclasses.field()
    

@dataclasses.dataclass
class GetTweetsFirehoseStreamResponse:
