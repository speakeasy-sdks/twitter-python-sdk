...
from ..shared import get2usersidtweetsresponse as shared_get2usersidtweetsresponse
from ..shared import problem as shared_problem


@dataclasses.dataclass
class UsersIDTweetsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    
class UsersIDTweetsExcludeEnum(str, Enum):
    REPLIES = "replies"
    RETWEETS = "retweets"


@dataclasses.dataclass
class UsersIDTweetsQueryParams:
    ...
    exclude: Optional[list[UsersIDTweetsExcludeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'exclude', 'style': 'form', 'explode': False }})
...
@dataclasses.dataclass
class UsersIDTweetsRequest:
    path_params: UsersIDTweetsPathParams = dataclasses.field()
    query_params: UsersIDTweetsQueryParams = dataclasses.field()
    security: UsersIDTweetsSecurity = dataclasses.field()
    

@dataclasses.dataclass
class UsersIDTweetsResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get2_users_id_tweets_response: Optional[shared_get2usersidtweetsresponse.Get2UsersIDTweetsResponse] = dataclasses.field(default=None)
