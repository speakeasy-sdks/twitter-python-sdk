...
from ..shared import get2spacesresponse as shared_get2spacesresponse
from ..shared import problem as shared_problem


@dataclasses.dataclass
class FindSpacesByIdsQueryParams:
...
@dataclasses.dataclass
class FindSpacesByIdsRequest:
    query_params: FindSpacesByIdsQueryParams = dataclasses.field()
    security: FindSpacesByIdsSecurity = dataclasses.field()
    

@dataclasses.dataclass
class FindSpacesByIdsResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get2_spaces_response: Optional[shared_get2spacesresponse.Get2SpacesResponse] = dataclasses.field(default=None)
